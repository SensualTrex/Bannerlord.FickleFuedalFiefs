...
public class SettlementReligionVM : FilterableViewModel
{
    ...
    private string _settlementReligionTitle;
    ...
    public SettlementReligionVM(Settlement settlement, Action onComplete)
    {
        ...
        SettlementReligionTitle = settlement.Name.ToString() + " Religions";
        RefreshDataView();
    }
    ...
    private void RefreshDataView()
    {
        ...
        foreach (SettlementReligion religion in _settlementReligion.SettlementReligions.Values) {
            var _populationCount = _settlementReligion.PopulationCount[religion.ReligionId];
            var _conversionRate = _settlementReligion.ConversionRates[religion.ReligionId];
            Rows.Add(new SettlementReligionSectionVM(religion, _populationCount, _conversionRate));
        }
    ...
    [DataSourceProperty]
    public string SettlementReligionTitle
    {
        get
        {
            return _settlementReligionTitle;
        }
        set
        {
            if (value != _settlementReligionTitle)
            {
                _settlementReligionTitle = value;
                base.OnPropertyChangedWithValue<string>(value, "SettlementReligionTitle");
            }
        }
    }
