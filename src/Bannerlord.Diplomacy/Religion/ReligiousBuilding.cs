...
namespace Religions.Religion
{
    ...
    public class ReligiousBuildingDescription
    {
        ...
        public ReligiousBuildingDescription(string buldingId, string buldingName, string description, string religionId, ReligiousBuildingType type, ReligiousBuildingLevel level)
